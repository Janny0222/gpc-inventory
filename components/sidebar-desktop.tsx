...
export function SidebarDesktop(props: SidebarDesktopProps) {
  ...
  const handleSubmit = async () => {
    ...
    await signOut();
    router.push('http://10.20.10.108:3000/login')
  };
                  ...
                  <div className=' bg-black/60'>
                    <div className='ml-4'>
                      <Link href='/supplies/supply'>
                        <SidebarButton className='w-full focus:ring-2  hover:underline hover:text-green-200' icon={Container}>I.T Supply</SidebarButton>
                      </Link>
                    </div>
                    <div className='ml-4'>
                      <Link href='/supplies/switches-routers'>
                        <SidebarButton className={`w-full focus:ring-2 hover:underline hover:text-green-200 `} icon={Router}> Switches | Routers </SidebarButton>
                      </Link>
                    </div>
                  </div>
                )}
