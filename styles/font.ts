import { Anek_Latin, Big_Shoulders_Display, Inter, Lusitana, Roboto, Roboto_Flex, Rubik, Lato } from 'next/font/google';
...
export const anek_latin = Anek_Latin({subsets: ['latin'], weight: ["500", "800"]})
